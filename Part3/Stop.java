...
public class Stop implements Comparable<Stop> {    
    ...
    private Set<Stop> neighbours = new HashSet<>();
    public int depth;
    ...
    public Set<Stop> neighbours(){
        return Collections.unmodifiableSet(neighbours);
    }
    
    public void addNeighbour(Stop n){
        neighbours.add(n);
    }
     ...
     */
    //public void deleteInEdgesOfType(String type) {
     ...
     * [needed for removing Walking edges]
     */
    public void deleteOutEdgesOfType(String type) {
        neighbours.clear();
    }
}
